...
import (
	...
	eventaction "github.com/erniealice/cyta-golang/domain/event/event/action"
	eventcalendar "github.com/erniealice/cyta-golang/domain/event/event/calendar"
	eventdashboard "github.com/erniealice/cyta-golang/domain/event/event/dashboard"
	eventdetail "github.com/erniealice/cyta-golang/domain/event/event/detail"
	eventform "github.com/erniealice/cyta-golang/domain/event/event/form"
	eventlist "github.com/erniealice/cyta-golang/domain/event/event/list"
)

// ModuleDeps holds all dependencies for the event module.
type ModuleDeps struct {
	Routes           eventpkg.Routes
	EventTagRoutes   eventtagpkg.Routes
	RecurrenceRoutes recurrencepkg.Routes
	Labels           eventpkg.Labels
