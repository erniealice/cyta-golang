// Package event wires the cyta event-tag views (list page + drawer form)
...
import (
	...
	eventtag "github.com/erniealice/cyta-golang/domain/event/event_tag"
	cytaeventtagaction "github.com/erniealice/cyta-golang/domain/event/event_tag/action"
	cytaeventtaglist "github.com/erniealice/cyta-golang/domain/event/event_tag/list"
...
// EventTagModuleDeps holds all dependencies for the event-tag module.
type EventTagModuleDeps struct {
	Routes       eventtag.Routes
	Labels       eventtag.Labels
...
// EventTagModule holds all constructed event-tag views.
type EventTagModule struct {
	routes eventtag.Routes
	List   view.View
	Add    view.View
	Edit   view.View
...
// NewEventTagModule creates a new event-tag module with all views wired.
func NewEventTagModule(deps *EventTagModuleDeps) *EventTagModule {
...
func (m *EventTagModule) RegisterRoutes(r view.RouteRegistrar) {
