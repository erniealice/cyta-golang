...
import (
	...
	eventaction "github.com/erniealice/cyta-golang/domain/event/views/event/action"
	eventcalendar "github.com/erniealice/cyta-golang/domain/event/views/event/calendar"
	eventdashboard "github.com/erniealice/cyta-golang/domain/event/views/event/dashboard"
	eventdetail "github.com/erniealice/cyta-golang/domain/event/views/event/detail"
	eventform "github.com/erniealice/cyta-golang/domain/event/views/event/form"
	eventlist "github.com/erniealice/cyta-golang/domain/event/views/event/list"
)

// ModuleDeps holds all dependencies for the event module.
type ModuleDeps struct {
	Routes           event.EventRoutes
	EventTagRoutes   event.EventTagRoutes
	RecurrenceRoutes event.RecurrenceRoutes
